...
const Landing = () => {
  return (
    <>
      <nav className="w-full flex items-center justify-between px-8 py-2 bg-violet-500">
        ...
        <section className="container mx-auto flex flex-col items-center justify-center">
          <Link to={"/app"}>
            <Button
              ...
              variant={"outline"}
            >
              Login <ArrowUpRightIcon className="h-4 w-4 ml-2" />
            </Button>
          </Link>
        </section>
        <section className="container mx-auto mt-8 flex justify-center items-center">
          <img
            src="https://i.pinimg.com/736x/1f/1e/ca/1f1ecaa844472e3d90a0929af306b305.jpg" 
